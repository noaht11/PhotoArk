...
public abstract class OpenFileChooser extends FileFilter implements Choosable
{
	...
	public OpenFileChooser(JFrame _frame, String _extension, String desc)
	{
		this(_frame, new String[]{_extension}, desc);
	}
	
	public OpenFileChooser(JFrame _frame, String[] _extensions, String desc)
	{
		...
		jfc = new JFileChooser()
		{
		    ...
		    public void approveSelection()
		    {
		        ...
		        if(!f.exists() && getDialogType() == OPEN_DIALOG)
		        {
		            ...
		            JOptionPane.showMessageDialog(frame, message, "File does not exist", JOptionPane.ERROR_MESSAGE);
		            return;
		        }
